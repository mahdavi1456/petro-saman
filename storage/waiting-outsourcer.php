			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">منتظر برون سپار</h3>
					</div>
					<div class="box-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php
							$i = 1;
							$res = get_select_query("select * from factor_buy_body fbb inner join factor_buy fb on fbb.f_id = fb.f_id where fbb.fb_outsourcing = 'yes'");
							if(count($res) > 0){
							foreach ($res as $row) {
								$fb_id = $row['fb_id'];
								$f_id = $row['f_id'];
