	...
	<aside class="main-sidebar">
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="<?php check_active('apply-loan.php'); check_active('list-user.php'); check_active('rest.php'); check_active('set_schedule.php'); check_active('get_schedule.php'); check_active('add_group.php'); check_active('edit_group.php'); check_active('raw_rights.php'); check_active('payroll.php'); check_active('new_shift.php'); ?> treeview">
				...
				<li class="<?php check_active('indicator.php'); check_active('list_customs.php'); check_active('doc_type.php'); check_active('list_meeting.php'); check_active('list_rule.php'); ?> treeview">
			  		<a href="#"><i class="fa fa-folder-open"></i><span>دبیرخانه</span></a>
			  		<ul class="treeview-menu">
						<li class="<?php check_active('doc_type.php'); ?>"><a href="<?php get_url(); ?>secretariat/doc_type.php"><i class="fa fa-circle-o"></i>نوع سند</a></li>
						...
						<li class="<?php check_active('indicator.php'); ?>"><a href="<?php get_url(); ?>secretariat/indicator.php"><i class="fa fa-circle-o"></i>اندیکاتور</a></li>
						<li class="<?php check_active('list_meeting.php'); ?>"><a href="<?php get_url(); ?>secretariat/list_meeting.php"><i class="fa fa-circle-o"></i>صورت جلسه</a></li>
						<li class="<?php check_active('list_rule.php'); ?>"><a href="<?php get_url(); ?>secretariat/list_rule.php"><i class="fa fa-circle-o"></i>اساس نامه</a></li>
			  		</ul>
				</li>
