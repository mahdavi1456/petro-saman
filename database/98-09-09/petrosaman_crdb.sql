...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2019 at 12:48 PM
...
CREATE TABLE `apply_loan` (
  ...
  `al_date` date DEFAULT NULL COMMENT 'تاریخ درخواست',
...
(2, 1, '1398-09-04', 150000, 'درخواست وام خرید کتاب', 0, NULL, NULL, 0, NULL, NULL),
(3, 1, '1398-09-03', 100000, 'درخواست وام خرید منزل', 1, '1398-09-05', 'توسط مدیر تایید شد', 42, '1398-09-05', 'توسط منابع انسانی تایید شد'),
(7, 1, '1398-09-07', 120000, 'درخواست وام خرید موبایل', 0, NULL, NULL, 0, NULL, NULL);
...
(15, 14, 3, 17, 9520, 8520, 81110400, 1, 0, 0, 0, 0, 0, NULL, 3, '7 روزه');
...
(11, 13, 12, 20, 5600, 8520, 47712000, 1, 0, 1, NULL, 0, 0, '12 روزه', 2),
...
INSERT INTO `list_customs` (`lc_id`, `lc_type`, `c_id`, `lc_details`, `fb_id`, `lc_code`) VALUES
(4, 'ارسالی', 12, 'تایید و ارسال فاکتور منتهی به فروردین و خرداد', 8, '102739813000104770000113');
...
CREATE TABLE `received_indicator` (
  `ri_id` int(11) NOT NULL,
  `ri_number` text DEFAULT NULL COMMENT 'شماره نامه',
  `ri_reg_date` date DEFAULT NULL COMMENT 'تاریخ صدور نامه',
  `ri_sender` text NOT NULL COMMENT 'فرستنده',
  `ri_description` text DEFAULT NULL COMMENT 'شرح نامه',
  `ri_receive_date` date DEFAULT NULL COMMENT 'تاریخ دریافت نامه',
  `u_id` int(11) DEFAULT NULL COMMENT 'ارجاع به',
  `ri_reference_date` date DEFAULT NULL COMMENT 'تاریخ ارجاع'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(5, 'استحقاقی', 32, '1398-08-25', '1398-08-18', 0, 'dasdsad', 'به علت سفر کاری', 0, '0000-00-00', NULL, 0, '0000-00-00', NULL),
(6, 'استحقاقی', 32, '1398-08-25', '1398-08-18', 0, 'dasdsad', 'مرخصی تسویقی', 1, '1398-09-05', 'تایید مرخصی روزانه توسط مدیر', 0, '0000-00-00', NULL),
...
(7, 'استحقاقی', 32, '0000-00-00', '00:00:00', '00:00:00', '02:50:00', 'asda', 0, '0000-00-00', NULL, 0, '0000-00-00', NULL),
(8, 'ساعتی', 1, '1398-08-26', '10:30:00', '12:30:00', '02:00:00', 'vvv', 1, '1398-09-05', 'تایید مرخصی ساعتی توسط مدیر', 0, '0000-00-00', NULL);
...
CREATE TABLE `sender_indicator` (
  ...
  `si_send_date` date DEFAULT NULL COMMENT 'تاریخ ارسال نامه',
  ...
  `si_annex` text DEFAULT NULL COMMENT 'پیوست'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sender_indicator` (`si_id`, `si_receiver`, `si_send_date`, `si_description`, `si_details`, `si_text`, `si_annex`) VALUES
(1, 'شرکت اطمینان سازه شهربابک', '1398-09-07', 'تقاضای بررسی و تایید اجرای فونداسیون و آرماتوربندی', 'بدون توضیح', NULL, NULL),
(2, 'شرکت لوله اهواز', '1398-09-10', 'تکمیل پیش فاکتور فروش لوله', 'ندارد', ' بدینوسیله به پیوست3 نسخه فاکتور رسمی (7 برگ) به شماره 74و 75و 76 دوره ی اسفند ماه  سال97و فروردین ماه سال 98 تقدیم حضور  میگردد. تقاضا می شود نسخه رنگی را پس از امضا و مهر آن شرکت محترم به آدرس پستی این شرکت ارسال نمائید.\r\nپیشاپیش از حسن اعتماد آن شرکت محترم سپاسگزاری می گردد.', '7 برگ');
...
--
ALTER TABLE `factor_buy`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد فاکتور', AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `factor_buy_body`
--
ALTER TABLE `factor_buy_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور خرید', AUTO_INCREMENT=18;
...
--
ALTER TABLE `factor_log`
  MODIFY `l_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `media_factor`
  MODIFY `mf_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;

--
-- AUTO_INCREMENT for table `media_received_indicator`
--
ALTER TABLE `media_received_indicator`
  MODIFY `mri_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `media_sender_indicator`
  MODIFY `msi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
