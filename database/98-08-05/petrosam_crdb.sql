...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2019 at 07:46 PM
...
(1, 5, 7, 1, 'sale', 4, 200, 400, '2019-10-26', '21:09:04', NULL, NULL, NULL, 2, 2, 0),
(2, 5, 7, 2, 'sale', 0, 180, 0, '2019-10-26', '21:10:33', NULL, NULL, NULL, 2, 2, 0);
...
(1, 3, 7, 'محصول', '1398/8/4', 1, 1, 'نقدی'),
(2, 3, 7, 'محصول', '1398/8/4', 1, 1, 'نقدی');
...
(1, 1, 2, 2, 500, 1000, 500000, 1, 0, 1, 1, 200, 0, '1398-08-04', 1, ''),
(2, 2, 2, 2, 200, 1000, 200000, 1, 0, 1, 1, 180, 0, '1398-08-04', 1, '');
...
(1, 'ذغال سنگ', 'کیلوگرم', 'محصول'),
(2, 'گرافیت', 'کیلوگرم', 'محصول');
...
--
ALTER TABLE `analyze_form`
  MODIFY `analyze_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bar_bring`
--
ALTER TABLE `bar_bring`
  MODIFY `bar_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد بار', AUTO_INCREMENT=3;
...
--
ALTER TABLE `factor`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `factor_body`
--
ALTER TABLE `factor_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور فروش', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `factor_buy`
--
ALTER TABLE `factor_buy`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد فاکتور';

--
-- AUTO_INCREMENT for table `factor_buy_body`
--
ALTER TABLE `factor_buy_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور خرید';
...
--
ALTER TABLE `produce`
  MODIFY `prc_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد تولید', AUTO_INCREMENT=2;
