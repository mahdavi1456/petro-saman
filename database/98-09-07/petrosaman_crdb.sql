...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2019 at 06:17 PM
...
INSERT INTO `sender_indicator` (`si_id`, `si_receiver`, `si_send_date`, `si_description`, `si_details`) VALUES
(1, 'شرکت اطمینان سازه شهربابک', '1398-09-07', 'تقاضای بررسی و تایید اجرای فونداسیون و آرماتوربندی', 'بدون توضیح'),
(2, 'پیش فاکتور فروش لوله اهواز', '1398-09-10', 'تکمیل پیش فاکتور فروش لوله', 'ندارد');
...
--
ALTER TABLE `media_sender_indicator`
  MODIFY `msi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
