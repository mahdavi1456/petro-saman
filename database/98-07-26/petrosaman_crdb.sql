...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2019 at 10:01 PM
...
CREATE TABLE `bar_bring` (
  ...
  `fb_id` int(11) DEFAULT NULL COMMENT 'کد فاکتور',
...
INSERT INTO `bar_bring` (`bar_id`, `fb_id`, `fb_type`, `dr_id`, `bar_quantity`, `bar_date`, `bar_time`, `bar_pic_doc`, `bar_pic_gh`) VALUES
(38, 14, 'buy', 4, '100', '1398-07-25', '14:07:53', 'photo_2019-10-17_11-43-19.jpg', 'photo_2019-10-17_11-42-19.jpg');
...
(3, 'تامین کننده', 'تامین کننده', 'حامد', '', '', '', '0', '0', '', '', '', '', '', '', NULL, NULL, NULL, '', 'yes', '', '', '', '', '', '', '', '', '', '', '', '0', '0', '0', '0', '0', '0', '0', '0'),
(2, 'مشتری', 'مشتری', 'مهسا', '', '', '', '0', '0', '', '', '', '', '', '', NULL, NULL, NULL, '', 'yes', '', '', '0', '', '0', '0', '', '', '', '', '1570083590357.png', '1570030210171.jpg', '1570030210663.png', '', '', '1570029063487.jpg', '', '', ''),
...
(5, 'تامین کننده', 'مشتری', 'آیلین', 'ابراهیمی', 'گراتک', '', '0', '0', '', '', '', '', 'خیابان شهدا', '', NULL, NULL, NULL, '', 'yes', '', '', '', '', '', '', '', '', '', '', '', '1570025288698.png', '', '', '', '', '', '', ''),
...
INSERT INTO `factor_body` (`fb_id`, `f_id`, `p_id`, `cat_id`, `fb_quantity`, `fb_price`, `total_price`, `fb_verify_admin1`, `fb_send_customer`, `fb_verify_customer`, `fb_verify_finan`, `fb_amount_sent`, `fb_status`, `date_verify_finan`, `fd_id`) VALUES
(1, 1, 22, 2, 25000, 10000, 250000000, 42, 0, 42, 42, 25000, 1, '1398-07-21', NULL),
(2, 2, 56, 2, 123000, 45000, 5535000000, 1, 0, 1, 1, 123000, 1, '1398-07-22', NULL),
(3, 3, 19, 5, 12000, 45800, 549600000, 1, 0, 1, 0, 0, 0, NULL, NULL),
(4, 6, 21, 2, 15000, 45000, 675000000, 1, 0, 1, 0, 0, 0, NULL, NULL),
(9, 10, 21, 5, 140500, 18520, 2602060000, 1, 0, 1, 0, 0, 0, NULL, 2),
(8, 9, 56, 1, 455000, 98200, 44681000000, 1, 0, 1, 0, 0, 0, NULL, NULL),
(10, 13, 22, 1, 1000, 250, 250000, 42, 0, 42, 42, 200, 0, '1398-07-25', 2),
(11, 16, 17, 1, 15000, 2500, 37500000, 1, 0, 1, 1, 3600, 0, '1398-07-26', 2),
(12, 17, 19, 2, 12000, 52000, 624000000, 0, 0, 0, 0, 0, 0, NULL, 2),
(13, 18, 19, 2, 20, 2000, 40000, 0, 0, 0, 0, 0, 0, NULL, 1),
(14, 18, 20, 5, 500, 500, 250000, 0, 0, 0, 0, 0, 0, NULL, 1);
...
(1, 1, 56, 5, 150000, 25000, 3750000000, 1, 42, 1, 'yes', 100000, 1),
(2, 2, 56, 2, 500000, 15000, 7500000000, 1, 1, 1, 'no', 485000, 1),
(3, 3, 56, 5, 1000000, 12000, 12000000000, 1, 1, 1, 'yes', 210000, 0),
(4, 7, 56, 2, 2550000, 12650, 32257500000, 1, 1, 1, 'yes', 0, 0),
(5, 0, 56, 5, 36000, 250, 9000000, 0, 0, 1, NULL, 0, 0),
(6, 8, 56, 5, 250000, 360, 90000000, 1, 1, 1, 'yes', 0, 0),
(7, 9, 56, 5, 36000, 1400, 50400000, 1, 1, 1, NULL, 0, 0);
...
(5, 42, '1398/07/21 19:59', 1, NULL, 500, 0, 0, 0, 0),
...
(1, '1398/7/21', 1, 22, 2, 50000, 1),
(2, '1398/7/25', 1, 20, 1, 50000, 1),
(3, '1398/7/25', 1, 19, 1, 1000, 1);
...
INSERT INTO `storage_list` (`st_id`, `st_name`, `st_address`) VALUES
(5, 'انبار مرکزی کارخانه', 'شهرک صنعتی خضرا کرمان'),
(6, 'کارخانه پابدانا', 'کرمان');
...
(1, 'گراتک', '', 'مالی', 'gratech', '1456', '', '', '', '', '', '111111', '', '', '', '1', '', '', '', 'مجرد', '', 0, 0, 0, '', '', '', '', 'رفسنجان', '', '', '', ''),
...
(41, 'حبیب الله', 'پیله وری', 'مدیر', 'pilevary', '1234', '', '', '', '', '', '22222222', '', '', '', '1', '', '', '', 'مجرد', '', 0, 0, 0, '', '', '', '', '', '', '', '', ''),
(42, 'محمد', 'اسماعیلی', 'مدیر', 'mrm', '12345', '', '', '', '', '', '2222222', '', '', '', '1', '', '', '', 'مجرد', '', 0, 0, 0, '', '', '', '', '', '', '', '', ''),
(43, 'کاوه', 'نوروزی', 'مالی', 'kaveh', '12345', '', '', '', '', '', '3333333', '', '', '', '1', '', '', '', 'مجرد', '', 0, 0, 0, '', '', '', '', '', '', '', '', '');
...
--
ALTER TABLE `analyze_form`
  MODIFY `analyze_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `bar_bring`
--
ALTER TABLE `bar_bring`
  MODIFY `bar_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد بار', AUTO_INCREMENT=39;
...
--
ALTER TABLE `factor`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `factor_body`
--
ALTER TABLE `factor_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور فروش', AUTO_INCREMENT=15;
...
--
ALTER TABLE `factor_buy_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور خرید', AUTO_INCREMENT=8;
...
--
ALTER TABLE `produce`
  MODIFY `prc_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد تولید', AUTO_INCREMENT=4;
