...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2019 at 06:59 AM
...
CREATE TABLE `apply_loan` (
  ...
  `al_admin_verify` int(11) DEFAULT NULL,
...
INSERT INTO `apply_loan` (`al_id`, `u_id`, `al_date`, `al_amount`, `al_details`, `al_admin_verify`, `al_admin_date`, `al_admin_details`) VALUES
(2, 1, '1398-09-04', 150000, 'درخواست وام خرید کتاب', NULL, NULL, NULL),
(3, 1, '1398-09-03', 100000, 'درخواست وام خرید منزل', NULL, NULL, NULL);
...
(6, 'استحقاقی', 32, '1398-08-25', '1398-08-18', 0, 'dasdsad', 'مرخصی تسویقی', 0, '0000-00-00', NULL, 0, '0000-00-00', NULL),
(7, 'استحقاقی', 32, '1398-08-25', '1398-08-18', 0, 'dasdsad', 'سفر کاری', 1, '0000-00-00', NULL, 42, '0000-00-00', NULL);
