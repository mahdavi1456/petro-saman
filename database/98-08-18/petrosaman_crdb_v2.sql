...
(15, 14, 3, 17, 9520, 8520, 81110400, 0, 0, 0, 0, 0, 0, NULL, 3, '7 روزه');
...
CREATE TABLE `usage_tools` (
  ...
  `us_back` date DEFAULT NULL COMMENT 'تاریخ برگشت',
  `us_type` varchar(30) DEFAULT NULL COMMENT 'مصرفی یا امانتی',
  `us_quantity` float DEFAULT NULL COMMENT 'مقدار',
  `us_details_back` varchar(100) DEFAULT NULL COMMENT 'توضیحات برگشت',
  `us_quantity_back` float DEFAULT NULL COMMENT 'مقدار برگشتی'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `usage_tools` (`us_id`, `t_id`, `u_id`, `us_details`, `us_date`, `us_back`, `us_type`, `us_quantity`, `us_details_back`, `us_quantity_back`) VALUES
(39, 4, 1, 'خروج 3 عدد بیل مکانیکی', '1398-08-15', '0000-00-00', 'مصرفی', 3, '', NULL),
(40, 6, 1, 'خروج سیم مسی 200 متر', '1398-08-11', '1398-08-16', 'مصرفی', 200, 'برگشت 80 متر سیم مسی', 80),
(41, 5, 1, '6 عدد آچار امانت داده شد', '1398-08-13', '0000-00-00', 'امانتی', 3, NULL, NULL),
(43, 4, 1, 'امانتی بیل مکانیکی', '1398-08-05', '1398-08-10', 'امانتی', 2, '', 2),
(44, 5, 1, 'امانت آچار فرانسه به انبار مرکزی', '1398-08-18', '1398-08-21', 'امانتی', 2, 'برگشت داده شد', 1);
...
(44, 'امین', 'حسنی', 'امور مالی', 'amin', '123456', '', '', '', '', '', '', '', '', '', '1', '', '', '', 'مجرد', '', 0, 0, 0, '', '', '', '', '', '', '', '', '', '1572955789165.png');
...
--
ALTER TABLE `usage_tools`
  MODIFY `us_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
