...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2019 at 05:20 AM
...
(11, 23, 54, 5, 1000, 10000, 0, 1, 0, 0, 1, 0, NULL, 0, 0),
...
(27, 47, 54, 5, 1000, 1000, 0, 1, 0, 0, 0, 0, NULL, 0, 0),
(28, 48, 54, 5, 2500, 222, 0, 1, 0, 0, 1, 0, NULL, 0, 0);
...
--
ALTER TABLE `factor_buy`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد فاکتور', AUTO_INCREMENT=52;
--
