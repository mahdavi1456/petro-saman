...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2019 at 03:50 PM
...
INSERT INTO `factor_body` (`fb_id`, `f_id`, `p_id`, `cat_id`, `fb_quantity`, `fb_price`, `fb_verify_admin1`, `fb_send_customer`, `fb_verify_customer`, `fb_verify_docs`, `fb_verify_finan`, `fb_amount_sent`, `fb_status`) VALUES
(1, 1, 2, 1, 200, 250000, 1, 1, 1, 1, 1, 106, 0),
(3, 3, 2, 1, 200, 200000, 1, 1, 1, 1, 1, 200, 1),
(4, 3, 2, 1, 300, 250000, 1, 1, 1, 1, 1, 300, 1),
(5, 9, 2, 1, 300, 250000, 1, 0, 0, 0, 0, 0, 0),
(6, 10, 2, 1, 300, 250000, 1, 1, 1, 1, 1, 300, 1),
(7, 11, 2, 1, 300, 250000, 0, 0, 0, 0, 0, 0, 0),
(8, 15, 2, 1, 300, 250000, 0, 0, 0, 0, 0, 0, 0),
(9, 18, 2, 1, 25000, 5500, 0, 0, 0, 0, 0, 0, 0),
(10, 19, 2, 1, 12000, 6000, 1, 1, 1, 1, 1, 12000, 1),
(11, 21, 2, 5, 5000, 5500, 0, 0, 0, 0, 0, 0, 0),
(12, 22, 2, 1, 2500, 2000, 1, 1, 1, 1, 1, 0, 0),
(13, 91, 54, 1, 100, 10, 0, 0, 0, 0, 0, 0, 0),
(14, 98, 19, 2, 100, 1000, 1, 1, 1, 1, 1, 0, 0),
(15, 98, 19, 2, 100, 1000, 1, 0, 1, 1, 1, 0, 0);
...
INSERT INTO `factor_buy_body` (`fb_id`, `f_id`, `rm_id`, `cat_id`, `fb_quantity`, `fb_price`, `fb_verify_admin1`, `fb_verify_docs`, `fb_outsourcing`, `fb_amount_get`, `fb_status`) VALUES
(3, 7, 9, 1, 10000, 12222, 1, 1, 'yes', 10, 1),
(5, 7, 9, 1, 10000, 250000, 1, 1, 'no', 5, 1),
(7, 9, 10, 2, 10000, 210000, 1, 1, 'yes', 1000, 1),
(8, 11, 12, 2, 1000, 250000, 1, 1, 'yes', 0, 0),
(9, 15, 12, 2, 556545, 5400, 1, 1, NULL, 0, 0),
(10, 17, 13, 4, 50000, 3600, 1, 1, 'no', 0, 0),
(11, 23, 54, 5, 1000, 10000, 1, 1, NULL, 0, 0),
(12, 27, 54, 5, 1000, 1000, 0, 0, NULL, 0, 0),
(13, 29, 54, 5, 10000, 10000, 0, 0, NULL, 0, 0),
(14, 29, 54, 5, 100000, 10000000, 0, 0, NULL, 0, 0),
(15, 30, 54, 5, 10000, 1000000, 0, 0, NULL, 0, 0),
(16, 31, 54, 5, 1000, 100, 0, 0, NULL, 0, 0),
(17, 34, 54, 5, 1000, 1000, 0, 0, NULL, 0, 0),
(18, 34, 54, 5, 100, 1000, 0, 0, NULL, 0, 0),
(19, 36, 54, 5, 10000, 100, 0, 0, NULL, 0, 0),
(20, 37, 54, 5, 420, 45, 0, 0, NULL, 0, 0),
(21, 38, 54, 5, 10, 420, 0, 0, NULL, 0, 0),
(22, 43, 54, 5, 100000, 10000, 0, 0, NULL, 0, 0),
(23, 44, 54, 5, 10, 10, 1, 1, NULL, 0, 0),
(24, 45, 54, 5, 1000, 10000, 1, 1, NULL, 0, 0),
(25, 46, 54, 5, 100, 10000, 1, 1, 'yes', 0, 0),
(26, 46, 54, 5, 100, 1000, 1, 1, 'no', 0, 0),
(27, 47, 54, 5, 1000, 1000, 1, 1, 'no', 0, 0),
(28, 48, 54, 5, 2500, 222, 1, 1, 'yes', 0, 0),
(29, 52, 54, 5, 1000, 100, 1, 1, 'yes', 0, 0),
(30, 53, 54, 5, 1000, 1000, 0, 0, NULL, 0, 0),
(31, 54, 56, 5, 10000, 1000, 1, 1, 'yes', 0, 0),
(34, 54, 54, 5, 1000, 100, 0, 0, NULL, 0, 0),
(33, 55, 54, 5, 1000, 1000, 0, 0, NULL, 0, 0),
(35, 54, 56, 5, 10000, 10000, 0, 0, NULL, 0, 0),
(36, 59, 56, 5, 10000, 1000, 0, 0, NULL, 0, 0);
...
--
ALTER TABLE `factor`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
...
--
ALTER TABLE `factor_buy`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد فاکتور', AUTO_INCREMENT=60;
--
-- AUTO_INCREMENT for table `factor_buy_body`
--
ALTER TABLE `factor_buy_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور خرید', AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `media_factor`
  MODIFY `mf_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
