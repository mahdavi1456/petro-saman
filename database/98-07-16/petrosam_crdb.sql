...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2019 at 03:57 PM
...
--
ALTER TABLE `factor_log`
  MODIFY `l_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `returned_factor`
  MODIFY `re_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
