...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2019 at 11:25 AM
...
(11, 13, 12, 20, 5600, 8520, 47712000, 0, 0, 1, NULL, 0, 0, '12 روزه', 2),
...
CREATE TABLE `rest_day` (
  ...
  `r_admin_verify` tinyint(4) NOT NULL,
  `r_admin_date` date NOT NULL,
  `r_hr_verify` tinyint(4) NOT NULL,
...
INSERT INTO `rest_day` (`r_id`, `r_type`, `u_id`, `r_fromdate`, `r_todate`, `r_total`, `r_destination`, `r_details`, `r_admin_verify`, `r_admin_date`, `r_hr_verify`, `r_hr_date`) VALUES
(1, 'ساعتی', 1, '1398-08-26', '1398-08-27', '00:00:00', '999', 'bhh', 0, '0000-00-00', 0, '0000-00-00'),
(2, 'ساعتی', 1, '1398-08-26', '1398-08-27', '00:00:00', '999', 'bhh', 0, '0000-00-00', 0, '0000-00-00'),
(3, 'ساعتی', 1, '1398-08-25', '1398-08-12', '00:00:00', 'asdas', 'asdasdasd', 0, '0000-00-00', 0, '0000-00-00'),
(4, 'استحقاقی', 32, '1398-08-25', '1398-08-18', '00:00:00', 'dasdsad', 'asda', 0, '0000-00-00', 0, '0000-00-00'),
(5, 'استحقاقی', 32, '1398-08-25', '1398-08-18', '02:50:00', 'dasdsad', 'asda', 0, '0000-00-00', 0, '0000-00-00'),
(6, 'استحقاقی', 32, '1398-08-25', '1398-08-18', '02:50:00', 'dasdsad', 'asda', 0, '0000-00-00', 0, '0000-00-00'),
(7, 'استحقاقی', 32, '1398-08-25', '1398-08-18', '02:50:00', 'dasdsad', 'asda', 0, '0000-00-00', 0, '0000-00-00');
...
INSERT INTO `rest_hour` (`r_id`, `r_type`, `u_id`, `r_date`, `r_fromtime`, `r_totime`, `r_total`, `r_details`, `r_admin_verify`, `r_admin_date`, `r_hr_verify`, `r_hr_date`) VALUES
(1, 'ساعتی', 1, '0000-00-00', '00:00:00', '00:00:00', '00:00:00', 'bhh', 0, '0000-00-00', 0, '0000-00-00'),
(2, 'ساعتی', 1, '0000-00-00', '00:00:00', '00:00:00', '00:00:00', 'bhh', 0, '0000-00-00', 0, '0000-00-00'),
(3, 'ساعتی', 1, '0000-00-00', '00:00:00', '00:00:00', '00:00:00', 'asdasdasd', 0, '0000-00-00', 0, '0000-00-00'),
(4, 'استحقاقی', 32, '0000-00-00', '00:00:00', '00:00:00', '00:00:00', 'asda', 0, '0000-00-00', 0, '0000-00-00'),
(5, 'استحقاقی', 32, '0000-00-00', '00:00:00', '00:00:00', '02:50:00', 'asda', 0, '0000-00-00', 0, '0000-00-00'),
(6, 'استحقاقی', 32, '0000-00-00', '00:00:00', '00:00:00', '02:50:00', 'asda', 0, '0000-00-00', 0, '0000-00-00'),
(7, 'استحقاقی', 32, '0000-00-00', '00:00:00', '00:00:00', '02:50:00', 'asda', 0, '0000-00-00', 0, '0000-00-00'),
(8, 'ساعتی', 1, '1398-08-26', '10:30:00', '12:30:00', '02:00:00', 'vvv', 0, '0000-00-00', 0, '0000-00-00');
...
(1, 'سید مرتضی', 'مهدوی', 'مدیریت', 'gratech', '1456', '', '', '', '', '', '111111', '', '', '', '1', '', '', '', 'مجرد', '', 0, 0, 0, '', '', '', '', 'رفسنجان', '', '', '', '', '1572952350502.jpg'),
...
(42, 'محمد', 'اسماعیلی', 'مدیر', 'mrm', '123', '', '', '', '', '', '2222222', '', '', '', '1', '', '', '', 'مجرد', '', 0, 0, 0, '', '', '', '', '', '', '', '', '', ''),
...
--
ALTER TABLE `factor_buy`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد فاکتور', AUTO_INCREMENT=17;
...
--
ALTER TABLE `hse_rates`
  MODIFY `hr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `media_factor`
  MODIFY `mf_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
