...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2019 at 01:50 PM
...
--
-- Table structure for table `apply_imprest`
--

CREATE TABLE `apply_imprest` (
  `ai_id` int(11) NOT NULL,
  `u_id` int(11) DEFAULT NULL,
  `ai_date` date NOT NULL COMMENT 'تاریخ درخواست',
  `ai_amount` int(11) DEFAULT NULL COMMENT 'مبلغ درخواست',
  `ai_details` text DEFAULT NULL COMMENT 'توضیحات',
  `ai_admin_verify` tinyint(4) DEFAULT 0,
  `ai_admin_date` date NOT NULL,
  `ai_admin_details` text DEFAULT NULL,
  `ai_hr_verify` tinyint(4) DEFAULT 0,
  `ai_hr_date` date NOT NULL,
  `ai_hr_details` text DEFAULT NULL,
  `ai_finan_verify` int(11) DEFAULT 0 COMMENT 'تایید مالی',
  `ai_finan_date` date NOT NULL,
  `ai_finan_details` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `apply_imprest`
--

INSERT INTO `apply_imprest` (`ai_id`, `u_id`, `ai_date`, `ai_amount`, `ai_details`, `ai_admin_verify`, `ai_admin_date`, `ai_admin_details`, `ai_hr_verify`, `ai_hr_date`, `ai_hr_details`, `ai_finan_verify`, `ai_finan_date`, `ai_finan_details`) VALUES
(2, 1, '1398-09-04', 150000, 'درخواست وام خرید کتاب', 1, '1398-09-24', 'تایید شد', -42, '1398-09-24', 'تایید نشد', 0, '0000-00-00', NULL),
(3, 1, '1398-09-03', 100000, 'درخواست وام خرید منزل', 0, '0000-00-00', NULL, 0, '0000-00-00', NULL, 0, '0000-00-00', NULL),
(7, 1, '1398-09-07', 160000, 'درخواست وام خرید موبایل', 0, '0000-00-00', NULL, 0, '0000-00-00', NULL, 0, '0000-00-00', NULL);
...
CREATE TABLE `apply_loan` (
  ...
  `lpc_id` int(11) DEFAULT NULL,
  `al_details` text DEFAULT NULL,
  `al_admin_verify` int(11) DEFAULT 0,
  `al_admin_date` date NOT NULL,
  `al_admin_details` text DEFAULT NULL,
  `al_hr_verify` int(11) DEFAULT 0,
  `al_hr_date` date NOT NULL,
  `al_hr_details` text DEFAULT NULL,
  `al_finan_verify` int(11) DEFAULT 0,
...
INSERT INTO `apply_loan` (`al_id`, `u_id`, `al_date`, `lpc_id`, `al_details`, `al_admin_verify`, `al_admin_date`, `al_admin_details`, `al_hr_verify`, `al_hr_date`, `al_hr_details`, `al_finan_verify`, `al_finan_date`, `al_finan_details`) VALUES
(3, 1, '1398-09-24', 4, 'درخواست وام', 0, '0000-00-00', NULL, 0, '0000-00-00', NULL, 0, '0000-00-00', NULL);
...
(38, 11, '1576142170153.png', 'تصویر بسته ارسال شده', '1398-09-21');

-- --------------------------------------------------------

--
-- Table structure for table `doc_loading`
--

CREATE TABLE `doc_loading` (
...
--
-- Dumping data for table `doc_loading`
--

INSERT INTO `doc_loading` (`dl_id`, `dt_id`, `dl_name`, `dl_link`, `dl_date`) VALUES
(1, 8, 'سند 1', '../uploads/doc-loading/1398/9/1576324153769.png', '1398-09-23'),
(2, 8, 'سند 2', '../uploads/doc-loading/1398/9/1576324364592.pdf', '1398-09-23');
...
CREATE TABLE `doc_type` (
  `dt_id` int(11) NOT NULL,
  `dt_type` varchar(50) CHARACTER SET utf8 NOT NULL
...
INSERT INTO `doc_type` (`dt_id`, `dt_type`) VALUES
(11, 'بازرگانی'),
(9, 'هیئت مدیره'),
(8, 'شرکت');
...
(9, 'ارسالی', 'آلیاژ گستر اهورا', 'بدون توضیح', 12, '102739813000104770000113'),
(10, 'ارسالی', 'آلیاژ گستر اهورا', '', 9, '102739813000104770000113');

-- --------------------------------------------------------

--
-- Table structure for table `loan_points_ceiling`
--

CREATE TABLE `loan_points_ceiling` (
  `lpc_id` int(11) NOT NULL,
  `lpc_amount` int(11) NOT NULL COMMENT 'مبلغ وام',
  `lpc_points_needed` int(11) NOT NULL COMMENT 'امتیاز موردنیاز',
  `lpc_number` int(11) NOT NULL COMMENT 'تعداد اقساط'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `loan_points_ceiling`
--

INSERT INTO `loan_points_ceiling` (`lpc_id`, `lpc_amount`, `lpc_points_needed`, `lpc_number`) VALUES
(1, 10000000, 48, 2),
(3, 20000000, 54, 5),
(4, 5000000, 20, 2);
...
(22, 0, '1576138090208.jpg', '1398-09-21', 'file_letter'),
(23, 0, '1576138114598.pdf', '1398-09-21', 'file_letter'),
(24, 0, '1576139009483.png', '1398-09-21', 'file_letter'),
(25, 0, '1576139038635.pdf', '1398-09-21', 'تصویر نامه1'),
(26, 0, '1576139092183.png', '1398-09-21', 'تصویر نامه1'),
(29, 7, '1576145592963.pdf', '1398-09-21', 'file_letter');
...
(4, 'استحقاقی', 32, '1398-08-25', '1398-08-18', 0, 'dasdsad', 'به علت سفر کاری', -1, '1398-09-24', 'تایید نشد', 0, '0000-00-00', NULL),
...
(3, 'ساعتی', 1, '0000-00-00', '00:00:00', '00:00:00', '00:00:00', 'asdasdasd', -1, '1398-09-24', 'تایید نشد', 0, '0000-00-00', NULL),
...
(10, 'شرکت فولاد نطنز', '1398-09-17', 'معرفی آقای مهندس حسنی', 'جابجایی کارخانه', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p dir=\"rtl\" style=\"text-align: justify;\">تولید انواع میلگرد به حالت کلاف آجدار نطنز و میلگرد شاخه ای در دو نوع ساده و آجدار در این مجتمع انجام می گیرد. میلگردهای آجدار تولیدی این کارخانه تحت استاندارد ملی ۳۱۳۲ تولید می گردند. تجهیزات خطوط نورد تولید میلگرد از شرکت های معتبر ایتالیایی خریداری شده است و انواع میلگرد با قطر بالا تولید می شوند.</p>\r\n</body>\r\n</html>', 'a5', 1, -1, 'تایید نشد', '1398-09-24');
...
(22, 52, 5, '1398-09-23', '5 عدد فیلتر هوا قابل تعمیر', 1),
(23, 52, 5, '1398-09-23', '5 عدد فیلتر هوا غیر قابل تعمیر', -1);
...
(52, 7, 1, 'خروج 10 عدد فیلتر هوا', '1398-09-22', 'مصرفی', 10);
...
(1, 'سید مرتضی', 'مهدوی', 'مدیریت', 'gratech', '1456', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(58, 'یلدا', 'امیری', 'دبیرخانه', 'amiri', '123456', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '25', NULL, NULL, NULL, 0, 0, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '');
...
--
-- Indexes for table `apply_imprest`
--
ALTER TABLE `apply_imprest`
...
--
-- Indexes for table `doc_loading`
--
ALTER TABLE `doc_loading`
...
--
-- Indexes for table `loan_points_ceiling`
--
ALTER TABLE `loan_points_ceiling`
  ADD PRIMARY KEY (`lpc_id`);
...
--
-- AUTO_INCREMENT for table `apply_imprest`
--
ALTER TABLE `apply_imprest`
...
--
-- AUTO_INCREMENT for table `doc_loading`
--
ALTER TABLE `doc_loading`
...
--
ALTER TABLE `doc_type`
  MODIFY `dt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `list_customs`
  MODIFY `lc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `loan_points_ceiling`
--
ALTER TABLE `loan_points_ceiling`
  MODIFY `lpc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `media_received_indicator`
  MODIFY `mri_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `media_sender_indicator`
  MODIFY `msi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `received_indicator`
  MODIFY `ri_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `sender_indicator`
  MODIFY `si_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `usage_tools`
  MODIFY `us_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
