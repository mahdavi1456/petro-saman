...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2019 at 06:08 PM
...
CREATE TABLE `analyze_form` (
  ...
  `an_empty_weight` float NOT NULL DEFAULT 0,
  `am_empty_weight` float NOT NULL DEFAULT 0,
  `an_full_weight` float NOT NULL DEFAULT 0,
  `hb_empty_weight` float NOT NULL DEFAULT 0,
  `hm_empty_weight` float NOT NULL DEFAULT 0,
  `hb_full_weight` float NOT NULL DEFAULT 0,
  `ec_empty_weight` float NOT NULL DEFAULT 0,
  `em_empty_weight` float NOT NULL DEFAULT 0,
  `ec_full_weight` float NOT NULL DEFAULT 0,
  `sulfur_percent` float NOT NULL DEFAULT 0,
  `gm_weight` float NOT NULL DEFAULT 0,
  `gm_less_weight` float NOT NULL DEFAULT 0,
  `gm_dot_weight` float NOT NULL DEFAULT 0,
  `gm_more_weight` float NOT NULL DEFAULT 0
...
(14, 55, '1398/7/17', '1398/7/17', 'محمد اسماعیلی', '405', '30', 1.36, 20, 2, 1, 1, 1.99, 1, 1, 1.99, 0.65, 950, 800, 100, 50);
...
INSERT INTO `factor_body` (`fb_id`, `f_id`, `p_id`, `cat_id`, `fb_quantity`, `fb_price`, `total_price`, `fb_verify_admin1`, `fb_send_customer`, `fb_verify_customer`, `fb_verify_docs`, `fb_verify_finan`, `fb_amount_sent`, `fb_status`) VALUES
(1, 1, 2, 1, 200, 250000, 0, 1, 1, 1, 1, 1, 106, 0),
(3, 3, 2, 1, 200, 200000, 0, 1, 1, 1, 1, 1, 200, 1),
(4, 3, 2, 1, 300, 250000, 0, 1, 1, 1, 1, 1, 300, 1),
(5, 9, 2, 1, 300, 250000, 0, 1, 0, 0, 0, 0, 0, 0),
(6, 10, 2, 1, 300, 250000, 0, 1, 1, 1, 1, 1, 300, 1),
(7, 11, 2, 1, 300, 250000, 0, 0, 0, 0, 0, 0, 0, 0),
(8, 15, 2, 1, 300, 250000, 0, 0, 0, 0, 0, 0, 0, 0),
(9, 18, 2, 1, 25000, 5500, 0, 0, 0, 0, 0, 0, 0, 0),
(10, 19, 2, 1, 12000, 6000, 0, 1, 1, 1, 1, 1, 12000, 1),
(11, 21, 2, 5, 5000, 5500, 0, 0, 0, 0, 0, 0, 0, 0),
(12, 22, 2, 1, 2500, 2000, 0, 1, 1, 1, 1, 1, 0, 0),
(13, 91, 54, 1, 100, 10, 0, 0, 0, 0, 0, 0, 0, 0),
(14, 98, 19, 2, 100, 1000, 0, 1, 1, 1, 1, 1, 0, 0),
(15, 98, 19, 2, 100, 1000, 0, 1, 0, 1, 1, 1, 0, 0),
(16, 99, 19, 1, 1000, 14, 14000, 0, 0, 0, 0, 0, 0, 0),
(17, 99, 19, 1, 1000, 14, 14000, 0, 0, 0, 0, 0, 0, 0);
...
(38, 63, 54, 5, 2500, 10000, 25000000, 0, 0, NULL, 0, 0),
(39, 64, 56, 4, 100000, 84300, 8430000000, 1, 1, 'yes', 0, 0);
...
(57, 1, '1398/07/16 20:41', 39, ''),
(58, 1, '1398/07/16 20:42', 39, '');
...
(55, 1, '1398/05/23 19:50', 1, NULL, 1, 3, 1, 14, 0),
...
(31, 34, '1570369762708.jpg', '1398/7/14', 'invoice'),
(29, 33, '1570350008770.png', '1398/7/14', 'invoice'),
(24, 32, '1570348982299.png', '1398/7/14', 'invoice'),
(22, 27, '1570195069114.jpg', '1398/7/12', 'invoice'),
(23, 28, '1570200786598.jpg', '1398/7/12', 'invoice'),
(32, 37, '1570470335494.png', '1398/7/15', 'invoice');
...
--
ALTER TABLE `analyze_form`
  MODIFY `analyze_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `factor_buy_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور خرید', AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `factor_buy_log`
--
ALTER TABLE `factor_buy_log`
  MODIFY `l_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `factor_log`
--
ALTER TABLE `factor_log`
  MODIFY `l_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
