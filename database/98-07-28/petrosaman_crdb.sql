...
CREATE TABLE `bar_bring` (
  ...
  `st_id` int(11) DEFAULT 0 COMMENT 'کد انبار',
  ...
  `bar_analyze_id` tinyint(4) DEFAULT 0 COMMENT 'کد آنالیز'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `bar_bring` (`bar_id`, `st_id`, `fb_id`, `fb_type`, `dr_id`, `bar_quantity`, `bar_exited`, `bar_date`, `bar_time`, `bar_pic_doc`, `bar_pic_gh`, `bar_analyze_id`) VALUES
(38, 0, 14, 'buy', 4, 100, 2222, '1398-07-25', '14:07:53', 'photo_2019-10-17_11-43-19.jpg', 'photo_2019-10-17_11-42-19.jpg', 0),
(39, 5, 23, 'buy', 3, 1280, 0, '1398-07-28', '08:28:15', '', '', 0),
(40, 5, 23, 'buy', 4, 12499, 0, '1398-07-28', '08:57:22', '', '', 0),
(41, 0, 17, 'sale', 4, 1000, 980, '2019-10-20', '13:09:45', NULL, NULL, 0),
(42, 0, 17, 'sale', 3, 400, 300, '2019-10-20', '13:15:56', NULL, NULL, 0),
(43, 0, 17, 'sale', 3, 600, 580, '2019-10-20', '13:16:23', NULL, NULL, 0);
...
(3, 3, 19, 5, 12000, 45800, 549600000, 1, 0, 1, 1, 0, 0, '1398-07-28', NULL),
...
(12, 17, 19, 2, 12000, 52000, 624000000, 1, 0, 0, 0, 0, 0, NULL, 2),
(13, 18, 19, 2, 20, 2000, 40000, 0, 0, 0, 0, 0, 0, NULL, 1),
(14, 18, 20, 5, 500, 500, 250000, 0, 0, 0, 0, 0, 0, NULL, 1),
(15, 20, 22, 1, 2399, 1200, 2878800, 1, 0, 1, 1, 2399, 1, '1398-07-28', 2),
(17, 21, 22, 1, 123000, 9000, 1107000000, 1, 0, 41, 43, 57000, 0, '1398-07-28', 2);
...
--
ALTER TABLE `bar_bring`
  MODIFY `bar_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد بار', AUTO_INCREMENT=44;
...
--
ALTER TABLE `factor`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف', AUTO_INCREMENT=22;
