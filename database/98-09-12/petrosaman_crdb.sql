...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2019 at 01:47 PM
...
(7, 'استحقاقی', 32, '0000-00-00', '00:00:00', '00:00:00', '02:50:00', 'asda', 1, '1398-09-11', '....', 0, '0000-00-00', NULL),
...
INSERT INTO `sender_indicator` (`si_id`, `si_receiver`, `si_send_date`, `si_description`, `si_details`, `si_text`, `si_writer`, `si_admin_verify`, `si_admin_details`, `si_admin_date`) VALUES
(1, 'شرکت اطمینان سازه شهربابک', '1398-09-07', 'تقاضای بررسی و تایید اجرای فونداسیون و آرماتوربندی', 'بدون توضیح', NULL, NULL, 0, NULL, '0000-00-00'),
(2, 'شرکت لوله اهواز', '1398-09-10', 'تکمیل پیش فاکتور فروش لوله', 'ندارد', ' بدینوسیله به پیوست3 نسخه فاکتور رسمی (7 برگ) به شماره 74و 75و 76 دوره ی اسفند ماه  سال97و فروردین ماه سال 98 تقدیم حضور  میگردد. تقاضا می شود نسخه رنگی را پس از امضا و مهر آن شرکت محترم به آدرس پستی این شرکت ارسال نمائید.\r\nپیشاپیش از حسن اعتماد آن شرکت محترم سپاسگزاری می گردد.', 1, 1, 'lkm', '1398-09-12');
...
--
ALTER TABLE `media_sender_indicator`
  MODIFY `msi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
