...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2019 at 12:12 PM
...
INSERT INTO `storage_list` (`st_id`, `st_name`, `st_address`, `st_type`) VALUES
(5, 'انبار مرکزی کارخانه', 'شهرک صنعتی خضرا کرمان', 'storage'),
(6, 'کارخانه پابدانا', 'کرمان', 'outsourcer'),
(7, 'معدن ذغال سنگ', 'تست', 'miner');
