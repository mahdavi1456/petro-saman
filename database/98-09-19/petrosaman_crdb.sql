...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2019 at 01:16 PM
...
CREATE TABLE `points_ceiling` (
  ...
  `pc_admin_verify` tinyint(4) DEFAULT NULL COMMENT 'تایید مدیر'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `points_ceiling` (`pc_id`, `pc_amount`, `pc_points_needed`, `pc_admin_verify`) VALUES
(1, 200000, 17, 0),
(2, 500000, 60, 1),
(6, 12000000, 80, 1);
