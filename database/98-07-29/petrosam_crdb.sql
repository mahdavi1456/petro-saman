...
--
-- Host: localhost:3306
-- Generation Time: Oct 21, 2019 at 07:56 PM
...
CREATE TABLE `factor_body` (
  ...
  `delivery_time` varchar(100) DEFAULT NULL COMMENT 'مدت زمان تحویل'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(3, 3, 19, 5, 12000, 45800, 549600000, 1, 0, 0, 0, 0, 0, NULL, NULL, NULL),
(4, 6, 21, 2, 15000, 45000, 675000000, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL),
(9, 10, 21, 5, 140500, 18520, 2602060000, 0, 0, 0, 0, 0, 0, NULL, 2, NULL),
(8, 9, 56, 1, 455000, 98200, 44681000000, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL),
...
(12, 17, 19, 2, 12000, 52000, 624000000, 0, 0, 0, 0, 0, 0, NULL, 2, NULL),
(13, 18, 19, 2, 20, 2000, 40000, 0, 0, 0, 0, 0, 0, NULL, 1, NULL),
(14, 18, 20, 5, 500, 500, 250000, 0, 0, 0, 0, 0, 0, NULL, 1, NULL),
(15, 19, 19, 2, 40000, 23450, 938000000, 1, 0, 1, 1, 38000, 0, '1398-07-29', 2, NULL),
(16, 26, 19, 2, 55, 5500, 302500, 0, 0, 0, 0, 0, 0, NULL, 1, '20 روز پس از تحویل کالا');
...
CREATE TABLE `factor_buy` (
  ...
  `u_id` int(11) NOT NULL COMMENT 'کد کاربر',
  `f_VAT_status` int(11) DEFAULT '0' COMMENT 'وضعیت گواهی ارزش افزوده',
...
INSERT INTO `factor_buy` (`f_id`, `c_id`, `f_date`, `u_id`, `f_VAT_status`, `f_payment`) VALUES
(1, 3, '1398/7/21', 1, 0, NULL),
(2, 4, '1398/7/21', 1, 0, NULL),
(3, 3, '1398/7/21', 1, 0, NULL),
(4, 3, '1398/7/22', 1, 0, NULL),
(5, 3, '1398/7/22', 1, 0, NULL),
(6, 3, '1398/7/23', 1, 0, NULL),
(7, 4, '1398/7/25', 1, 0, 'نقدی'),
(8, 4, '1398/7/29', 1, 1, 'نقدی'),
(9, 4, '1398/7/29', 1, 1, 'غیر نقدی'),
(10, 3, '1398/7/29', 1, 1, 'نقدی');
...
(3, 3, 56, 5, 1000000, 12000, 12000000000, 1, 1, 1, 'yes', 210000, 0, NULL, 2),
(4, 7, 56, 2, 2550000, 12650, 32257500000, 1, 1, 1, 'yes', 0, 0, '24 فروردین', 1);
...
(17, 1, '1398/07/29 20:04', 15, '', 0, 0, 0, 0, 0),
(18, 1, '1398/07/29 20:04', 15, '', 0, 0, 0, 0, 0),
(19, 1, '1398/07/29 20:04', 15, NULL, 20000, 4, 0, 0, 0),
(20, 1, '1398/07/29 20:08', 15, NULL, 18000, 0, 0, 0, 0);
...
--
ALTER TABLE `factor`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `factor_body`
--
ALTER TABLE `factor_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور فروش', AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `factor_buy`
--
ALTER TABLE `factor_buy`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد فاکتور', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `factor_buy_body`
--
ALTER TABLE `factor_buy_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور خرید', AUTO_INCREMENT=5;
