...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2019 at 09:17 PM
...
(7, 4, '1398/7/25', 1, 0, NULL),
(8, 3, '1398/7/26', 1, 0, NULL),
(9, 3, '1398/7/26', 1, 0, NULL),
(10, 3, '1398/7/29', 1, 0, NULL),
(11, 4, '1398/7/29', 1, 0, NULL),
(12, 4, '1398/7/29', 1, 1, 'غیر نقدی'),
(13, 3, '1398/7/29', 1, 1, 'نقدی'),
(14, 3, '1398/7/29', 1, 1, 'نقدی'),
(15, 3, '1398/7/29', 1, 0, 'غیر نقدی');
...
--
ALTER TABLE `factor`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف', AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `factor_body`
--
ALTER TABLE `factor_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور فروش', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `factor_buy`
--
ALTER TABLE `factor_buy`
  MODIFY `f_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد فاکتور', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `factor_buy_body`
--
ALTER TABLE `factor_buy_body`
  MODIFY `fb_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'کد ردیف فاکتور خرید', AUTO_INCREMENT=9;
