...
$field_names[0] = "fb_id";
$field_types[0] = "int(11) NOT NULL COMMENT 'کد ردیف فاکتور فروش' AUTO_INCREMENT PRIMARY KEY";

$field_names[1] = "f_id";
$field_types[1] = "int(11) NOT NULL COMMENT 'کد فاکتور فروش'";
...
$field_names[12] = "fb_amount_sent";
$field_types[12] = "int(11) NOT NULL DEFAULT 0 COMMENT 'مقدار ارسال شده'";

$field_names[13] = "fb_status";
$field_types[13] = "tinyint(1) NOT NULL DEFAULT 0 COMMENT 'پایان یافته؟'";
