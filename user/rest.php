<?php include"../header.php"; include"../nav.php"; $u_id = $_SESSION['user_id']; $media = new media(); $user = new user();
	...
	if($u_level == "مدیریت"){
		...
		$person_list = get_select_query("select * from rest where u_id = $u_id");
	}
	?>
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
							...
							<div id="details" class="col-md-12">
								...
								<form action="" method="post" id="hourly-form" style="display: none">
									<div class="row">
										...
										<div class="item col-md-2">
											<label>تاریخ</label>
											<input type="text" name="r_date" placeholder="تاریخ" class="date_picker form-control" autocomplete="off">
										</div>
										<div class="item col-md-2">
											<label>از ساعت</label>
			  		...
			  		<div class="box">
			  			<div class="box-header"><h3 class="box-title">لیست درخواست های مرخصی</h3></div>
			  			<div class="box-body">
